...
public class CatalogInputHandler {
	...
	public CatalogInputHandler(JTextField targetField, JTextField raField, JTextField decField, JTextField fovField,
	...
	protected boolean handleAllInputs() {
		return handleInput(raField) && handleInput(decField) && handleInput(fovField) && handleInput(magLimitField);
	}

	protected boolean handleInput(JTextField textField) {
