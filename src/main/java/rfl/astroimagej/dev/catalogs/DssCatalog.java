 ...
 * </p>
 */
public class DssCatalog {
	
	/**
	 * Runs SkyView server query on DSS catalog to download 1000x1000 fits image for specified sky region.
	 * <p>
	...
	public static String downloadDssFits(CatalogQuery query) {	
		//this.query = query;
		String skyUrl = CatalogUrls.getUrl(query, CatalogMagType.DSS); 
